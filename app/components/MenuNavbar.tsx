  ...
  return (
    <>
      ...
      <nav
        className={
          displayMenuNavbar
            ? 'fixed left-0 top-0 w-[80%] sm:w-[60%] md:w-[40%] lg:w-[30%] h-full bg-slate-100 border-r border-gray-500 ease-out duration-300 z-20'
            : 'fixed left-[-100%] top-0 w-[40%] h-full bg-gray-300 border-r border-gray-500 ease-in duration-300'
        }
      >
        <CgClose
          size={25}
          ...
          onClick={() => setDisplayMenuNavbar(!displayMenuNavbar)}
        />
        <div className="p-5">
          <img
          ...
          <ul className="flex flex-col gap-2 mt-5 font-semibold text-2xl">
            <li className="hover:text-[#f2295b] cursor-pointer">
              Página Inicial
            </li>
